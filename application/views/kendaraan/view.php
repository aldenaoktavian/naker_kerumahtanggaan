        ...
        <div style="margin-top:50px;">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="nup" placeholder="NUP" value="<?php echo $detail_kendaraan[0]['nup']; ?>" readonly />
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="no_mesin" placeholder="No Mesin" value="<?php echo $detail_kendaraan[0]['no_mesin']; ?>" readonly />
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="no_chasis" placeholder="No Chasis" value="<?php echo $detail_kendaraan[0]['no_chasis']; ?>" readonly />
                    </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="kondisi" placeholder="Kondisi" value="<?php echo $detail_kendaraan[0]['kondisi']; ?>" readonly />
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="direktorat" placeholder="Direktorat" value="<?php echo $detail_kendaraan[0]['direktorat']; ?>" readonly />
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
