...
<?php if($_SESSION['login']['id_user'] <> 1){ ?>
    <div class="blank">
            ...
            <div style="margin-top:50px;">
                <form action="<?php echo base_url().'pengadaan_barang/edit/'.$id; ?>" method="POST">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <input type="textarea" class="form-control" name="alasan_pengadaan" placeholder="Alasan Pengadaan" value="<?php echo $detail_request[0]['alasan_pengadaan']; ?>" />
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <input type="textarea" class="form-control" name="spesifikasi" placeholder="Spesifikasi" value="<?php echo $detail_request[0]['spesifikasi']; ?>" />
                        </div>
                    </div>
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
...
<?php
    ...
    <div class="blank">
        <div class="blank-page">
            <h4><?php echo $menu_title; ?></h4>
            <div style="margin-top:50px;">
                <form action="<?php echo base_url().'pengadaan_barang/edit_admin/'.$id; ?>" method="POST">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            Kode Pengadaan Barang
                        </div>
