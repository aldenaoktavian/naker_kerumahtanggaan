	...
	<div class="blank-page">
        ...
        <div style="margin-top:50px;">
            ...
            <?php if(isset($_SESSION['perawatan_barang']['message'])){ ?>
                <div style="color:<?php echo $_SESSION['perawatan_barang']['message_color']; ?>;"><?php echo $_SESSION['perawatan_barang']['message']; ?></div>
            <?php } ?>
...
$( document ).ready(function(){
    $('#data_search').load("<?php echo base_url().'perawatan_barang/data_search'; ?>");
});
...
<?php 
unset($_SESSION['perawatan_barang']);
