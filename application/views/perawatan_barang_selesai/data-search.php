            <table class="table table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td>Approved</td>
                        <td>
                            <a href="<?php echo base_url().'perawatan_barang_selesai/edit/'.md5($perawatan_selesai['id']); ?>"><button type="button" class="btn btn-default <?php echo $is_update; ?>">Edit</button></a>
                        </td>
                    </tr>
                <?php $nourut++; } ?>
                </tbody>
