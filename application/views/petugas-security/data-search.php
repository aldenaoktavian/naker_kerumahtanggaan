            <table class="table table-striped">
                ...
                ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url().'petugas_security/edit/'.md5($data_petugas['id']); ?>"><button type="button" class="btn btn-default">Edit</button></a>
                            <a href="#" onclick="deleteData('<?php echo base_url().'petugas_security/delete/'.md5($data_petugas['id']); ?>')"><button type="button" class="btn btn-danger">Delete</button></a>
                        </td>
                    </tr>
                <?php $nourut++; } ?>
                </tbody>
