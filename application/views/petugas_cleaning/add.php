...
<div class="blank">
	<div class="blank-page">
        ...
        <div style="margin-top:50px;">
            <form action="<?php echo base_url().'petugas_cleaning/add'; ?>" method="POST">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        Kode Petugas
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="kode_petugas" value="<?php echo $getKodePetugas; ?>" readonly />
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    ...
                    <a href="<?php echo base_url().'petugas_cleaning'; ?>"><button type="button" class="btn btn-default">Cancel</button></a>
                </div>
