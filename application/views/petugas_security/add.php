...
<div class="blank">
	<div class="blank-page">
        ...
        <div style="margin-top:50px;">
            <form action="<?php echo base_url().'petugas_security/add'; ?>" method="POST">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    ...
                    <a href="<?php echo base_url().'petugas_security'; ?>"><button type="button" class="btn btn-default">Cancel</button></a>
                </div>
