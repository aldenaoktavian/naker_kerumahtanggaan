...
<div class="blank">
    <div class="blank-page">
        ...
        <div style="margin-top:50px;">
            <form action="<?php echo base_url().'tugas_cleaning/edit/'.$id; ?>" method="POST">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                        Kode Jadwal
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                        <input type="text" class="form-control" name="kode_jadwal" value="<?php echo $cleaning[0]['kode_jadwal']; ?>" readonly />
                    </div>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 form-space">
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                ...
                <div>
                    <table class="table table-striped">
                        ...
                        <?php if ($detail_cleaning > 0) { ?>
                            <?php foreach ($detail_cleaning as $i=>$v) { //echo "<pre>"; print_r($v); echo "</pre>"; exit; ?>
                        <tr id="tr<?php echo $i;?>">
                        ...
                        <tr id="trHiddenCounterDetail" style="display:none;">
                            <input id="tr_d_counterDetail" type="hidden" value="<?php echo $detail_cleaning?(sizeof($detail_cleaning)-1):0;?>">
                        </tr>
